...
public class BuscaMinasMainActivity extends Activity implements OnTouchListener {
	
	
	private Tablero fondo;
    int x, y;
    private CasillaActivity[][] casillas;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_busca_minas_main);
        ...
        casillas = new CasillaActivity[8][8];
        for (int f = 0; f < 8; f++) {
            for (int c = 0; c < 8; c++) {
                casillas[f][c] = new CasillaActivity();
            }
        }
        this.disponerBombas();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.busca_minas_main, menu);
		return true;
	}
                ...
                for (int c = 0; c < 8; c++) {
                    if (casillas[f][c].dentro((int) event.getX(),
                        ...
                        if (casillas[f][c].contenido == 80) {
                            Toast.makeText(this, "Booooooooommmm, Perdiste",
